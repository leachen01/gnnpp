...
def get_feature_list(mode: str, test_df=None):
    if mode == "gnnexplainer":
        if test_df == None:
            feature_names = ['time', 'station_id',
                             'model_orography', 'station_altitude', 'station_latitude', 'station_longitude',
                             'cape_mean', 'cape_std', 'sd_mean', 'sd_std', 'stl1_mean', 'stl1_std', 'swvl1_mean',
                             'swvl1_std', 't2m_mean', 't2m_std', 'tcc_mean', 'tcc_std', 'tcw_mean', 'tcw_std',
                             'tcwv_mean', 'tcwv_std', 'u10_mean', 'u10_std', 'u100_mean', 'u100_std', 'v10_mean', 'v10_std', 'v100_mean',
                             'v100_std', 'vis_mean', 'vis_std', 'cp6_mean', 'cp6_std', 'mn2t6_mean', 'mn2t6_std', 'mx2t6_mean',
                             'mx2t6_std', 'p10fg6_mean', 'p10fg6_std', 'slhf6_mean', 'slhf6_std', 'sshf6_mean',
                             'sshf6_std', 'ssr6_mean', 'ssr6_std', 'ssrd6_mean', 'ssrd6_std', 'str6_mean', 'str6_std', 'strd6_mean', 'strd6_std',
                             'tp6_mean', 'tp6_std', 'z_mean', 'z_std', 'q_mean', 'q_std', 'u_mean', 'u_std', 'v_mean', 'v_std',
                             't_mean', 't_std', 'number']
        else:
            feature_names = [f for f in test_df.columns.tolist()]
    elif mode == "pi":
        if test_df == None:
            feature_names = ['station_id', 'model_orography', 'station_altitude', 'station_latitude',
                             ...
                             'v100_mean', 'v100_std', 'vis_mean', 'mn2t6_std', 'mx2t6_mean', 'mx2t6_std', 'p10fg6_mean',
        ...
        assert test_df is not None, "Either normal == True, or insert a dataframe to retrieve features from column names."
