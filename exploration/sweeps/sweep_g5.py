...
#     train_path = f'exploration/graphs/{leadtime}/train_{leadtime}-Agallod2d3Eg50-a4-o15-d2003-d30074.pt'
#     valid_path = f'exploration/graphs/{leadtime}/valid_{leadtime}-Agallod2d3Eg50-a4-o15-d2003-d30074.pt'
#     test_rf_path = f'exploration/graphs/{leadtime}/test_rf_{leadtime}-Agallod2d3Eg50-a4-o15-d2003-d30074.pt'
#     test_f_path = f'exploration/graphs/{leadtime}/test_f_{leadtime}-Agallod2d3Eg50-a4-o15-d2003-d30074.pt'
#
...
#                                                                      attributes=["geo", "alt", "lon", "lat", "alt-orog", "dist2", "dist3"],
#                                                                      edges=[("geo", 50),("alt", 4), ("alt-orog", 1.5), ("dist2", 0.003), ("dist3", 0.0074)],
#                                                                      sum_stats=True)
#     graphs5_valid_rf, graphs5_test_rf, graphs5_test_f = tests5
#     os.makedirs(f'exploration/graphs/{leadtime}', exist_ok=True)
#     torch.save(graphs5_train_rf, path_list[0])
#     torch.save(graphs5_valid_rf, path_list[1])
#     torch.save(graphs5_test_rf, path_list[2])
#     torch.save(graphs5_test_f, path_list[3])
#     return graphs5_train_rf, graphs5_valid_rf, graphs5_test_rf, graphs5_test_f
...
if __name__ == "__main__":
    ...
    g5_valid_loader = DataLoader(graphs5_valid_rf, batch_size=8, shuffle=False)
    g5_test_f_loader = DataLoader(graphs5_test_f, batch_size=8, shuffle=False)
    g5_test_rf_loader = DataLoader(graphs5_test_rf, batch_size=8, shuffle=False)
    ...
    PROJECTNAME = "sweep_g5"   # wandb sweep --project sweep_g5 sweep_g5.yaml
